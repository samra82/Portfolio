  ...
  return (
    <section className="mt-8 sm:mt-16 min-h-screen flex items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl text-center relative z-10 w-full">
        ...
        <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white mb-4 sm:mb-6 relative inline-block drop-shadow-[0_0_10px_rgba(139,75,236,0.5)] transition-opacity duration-700 delay-100 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-b from-white to-purple-300">
            Samra Shafiq
          </span>
          <span className="absolute inset-0 text-purple-400 opacity-20 -z-10 blur-lg">
            Samra Shafiq
          </span>
        </h1>
